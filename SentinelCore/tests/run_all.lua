local tests = {
    ...
    "tests/test_ai005_human_timing",
    "tests/test_ai006_combat_context",
    ...
    "tests/test_ai029_aoe_kite_tactic",
    "tests/test_ai030_aoe_tactical_smoke",
    ...
    "tests/test_sc032_ranged_combat_chase",
}
