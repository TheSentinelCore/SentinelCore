...
use sentinel_query_server::services::{
    ...
    DefaultInnkeeperService, DefaultItemService, DefaultMetaService, DefaultTrainerService,
...
use sentinel_query_server::storage::repositories::item::ItemRepository;
...
async fn main() -> anyhow::Result<()> {
    ...
    let item_repo = Arc::new(ItemRepository::new(store.clone()));
    ...
    let state = Arc::new(ServerBlackboard {
        ...
        item: Arc::new(DefaultItemService::new(item_repo)),
