...
local menu_elements = {
    ...
    log_perception = core.menu.checkbox(false, TAG .. "log_perception"),
    log_wm         = core.menu.checkbox(false, TAG .. "log_world_model"),
    log_intent     = core.menu.checkbox(true,  TAG .. "log_intent"),
    log_combat     = core.menu.checkbox(false, TAG .. "log_combat"),
    log_nav        = core.menu.checkbox(false, TAG .. "log_nav"),
    diag_node      = core.menu.tree_node(),
    diag_enabled   = core.menu.checkbox(false, TAG .. "diag_enabled"),
    diag_tick      = core.menu.checkbox(true, TAG .. "diag_tick"),
    diag_console   = core.menu.checkbox(false, TAG .. "diag_console"),
