...
> **Tip:** You should check [User Combat Forecast Guide](/dev/libraries/modules/combat-forecast) to understand what this module is about in more depth before starting to work with it.
...
> **Tip:** Always ensure that you validate the combat length before casting spells with **long cooldowns** or spells that have a **long cast time**. This approach will prevent unnecessary use of critical abilities in short fights, optimizing your overall strategy.
