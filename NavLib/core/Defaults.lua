...
Defaults.movement = {
    ...
    dynamic_speed_max_tolerance_scale = { type = "float", min = 1.0,  max = 2.0,   default = 1.20,  id = "navlib_dyn_tol_scale" },
    dynamic_speed_max_tolerance_bonus = { type = "float", min = 0.0,  max = 2.0,   default = 0.75,  id = "navlib_dyn_tol_bonus" },
    dynamic_speed_ramp_z_delta        = { type = "float", min = 0.5,  max = 5.0,   default = 1.2,   id = "navlib_dyn_ramp_z" },
    dynamic_speed_ramp_tolerance      = { type = "float", min = 0.5,  max = 5.0,   default = 1.8,   id = "navlib_dyn_ramp_tol" },
    dynamic_speed_ramp_look_distance  = { type = "float", min = 2.0,  max = 15.0,  default = 6.0,   id = "navlib_dyn_ramp_look" },
