...
---@field public cc_flags cc_flags
---@field public damage_type_flags damage_type_flags
---@field public cc_flag_descriptions table<number, string>
---@field public dr_categories table<number, string>
---@field public no_dr_flags table<number, boolean>
---@field public DR_RESET_TIME number
---@field public game_version string
---@field public is_retail boolean
---@field public is_tbc boolean
---@field public is_wotlk boolean
---@field public is_mop boolean
---@field public is_classic_era boolean
...
---@field public is_immune_to_heal fun(self: pvp_helper, unit: game_object, min_remaining_ms: number?): boolean, number, number
