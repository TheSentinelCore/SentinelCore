...
---@field public get_wrapped_text_size fun(self:window, text:string, width:number):vec2 -- Returns the size of the text when wrapped to the given width
...
---@field public get_available_region fun(self:window):vec2 -- Returns the available region size for content
---@field public get_min_size fun(self:window):vec2 -- Returns the minimum size of the window
---@field public get_scroll fun(self:window):vec2 -- Returns the current scroll position (x, y)
---@field public get_max_scroll_y fun(self:window):number -- Returns the maximum scroll Y value
---@field public set_scroll_y fun(self:window, scroll:number):nil -- Sets the scroll Y position
---@field public center_text fun(self:window, text:string):nil -- Centers the text horizontally in the window
...
---@field public is_window_focused fun(self:window):boolean -- Returns true if the window is currently focused
---@field public is_any_item_active fun(self:window):boolean -- Returns true if any item is currently active
...
---@field public render_text_custom_size fun(self:window, font_id:integer, pos_offset:vec2, col:color, font_size:number, text:string):nil -- Renders text with a custom font size
---@field public render_text_wrapped fun(self:window, text:string, color:color, max_wrap_width:number):nil -- Renders text that wraps at the given width
...
---@field public pop_font fun(self:window):nil -- Pops the previously pushed font
...
---@field public push_clip_rect fun(self:window, min:vec2, max:vec2, intersect:boolean):nil -- Pushes a clipping rectangle onto the stack
---@field public pop_clip_rect fun(self:window):nil -- Pops the previously pushed clipping rectangle
---@field public set_id fun(self:window, id:string):nil -- Sets the window ID
---@field public get_type fun(self:window):integer -- Returns the window type
---@field public set_render_layer fun(self:window, layer:integer):nil -- Sets the render layer for the window
---@field public get_close_cross_bounds fun(self:window):table -- Returns a table with min and max vec2 representing the close cross bounds relative to window position
